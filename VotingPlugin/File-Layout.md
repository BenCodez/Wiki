...
> 💡 Reward keys can usually be used inline under a VotingPlugin `Rewards` section or at the top level of a standalone reward file. Do not add an extra top-level `Rewards:` wrapper inside a standalone file; see [Reward File](Reward-File).
{.is-info}
