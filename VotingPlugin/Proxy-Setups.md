...
| [HTTP](/VotingPlugin/proxy-method-HTTP) | Development-only transport using one proxy TLS listener and outbound mutually authenticated backend connections. VotingPlugin 7.1.1 does not include it. |
