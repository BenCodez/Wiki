...
- VotingPlugin 7.1.1 has no direct Redis SSL/TLS option. Use a trusted private tunnel or TLS-terminating proxy when traffic must cross untrusted networks.
